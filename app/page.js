              ...
              <div className="flex gap-3">
                {[
                  ...
                  <motion.a key={i} whileHover={{ y: -3, scale: 1.1 }} whileTap={{ scale: 0.95 }}
                    ...
                    className="w-11 h-11 rounded-xl bg-slate-800/50 border border-white/[0.05] hover:border-cyan-500/30 flex items-center justify-center text-slate-400 hover:text-cyan-400 transition-all duration-300">
                    {social.svg}
                  </motion.a>
                ))}
              </div>
